...
%    every node/.style={fill=white, font=\sffamily}, align=center]
  ...
  \node (stopscreen) [decision, join] {Recall $\geq$ target?};
   

  
  
  \node (reldocs) [multidoc, below of=stopscreen, xshift=20mm, yshift=-8mm]  {Relevant documents};
  \node (irreldocs) [multidoc, fill=blue!5, below of=stopscreen, xshift=-20mm, yshift=-8mm]  {Irrelevant documents};
  %\node 
...
% \draw [o->,norm] (recall.west) -- (c3) |-  (screenr2.west);
 ...
 \draw [o->,norm] (stopscreen.south) -- (reldocs);
 \draw [o->,norm] (stopscreen.south) -- (irreldocs);
