...
\subsection*{A Statistical Stopping Criterion for Active Learning}
	...
	\begin{equation}
		\tau = \frac{\hat{\rho}}{\rho + \tilde{n}}.
	\end{equation}
	Reorganization of this equation gives
	\begin{equation}
		\tilde{n} = \frac{\hat{\rho}}{\tau} - \rho.
	\end{equation}
	Because we need to use integers and want a conservative estimation, we are using the next largest integer given by the ceiling function:
	\begin{equation}
